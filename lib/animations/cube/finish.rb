...
module Claudine
  module Animations
    module Cube
      # After a tool (success): a crown of crenellations (rampart merlons) at the base of the 4 side faces, rotating all the way around the cube.
      # A continuous base row (y=0) with teeth that rise (up to HEIGHT), a pattern that scrolls around the cube.
      # Same orange/amber as the snake (pre_tool).
      # Signature: a crenellated crown rotating at the base.
