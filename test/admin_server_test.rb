...
class AdminServerTest < Minitest::Test
  def setup
    ...
    @srv.start
    30.times do
      begin; get('/api/state'); break; rescue Errno::ECONNREFUSED; sleep 0.05; end
    end
  end
  ...
  def test_state
    ...
    assert_equal 0.25, s['boost_ceiling']
  ...
  def test_integration
    ...
    assert_equal false, JSON.parse(get('/api/state').body)['integrations']['claude_code']
