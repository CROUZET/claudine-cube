...
class ConfigTest < Minitest::Test
  ...
  def test_integrations_default_on
    ...
    assert_equal true, c.to_state[:integrations]['claude_code']
  end
  ...
  def test_set_integration_persists
    ...
    assert_equal false, JSON.parse(File.read(@file))['integrations']['claude_code']
  ...
  def test_brightness_and_integrations_coexist
    ...
    assert_equal false, data['integrations']['claude_code']
  end

  def test_any_integration_enabled
    c = cfg
    assert c.any_integration_enabled?
    c.set_integration('claude_code', false)
    refute c.any_integration_enabled?
  end
